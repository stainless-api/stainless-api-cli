...
func createProjectsConfigCreateBranchSubcommand(initialBody []byte) (Subcommand) {
  var projectName *string = nil
  query := []byte("{}")
  header := []byte("{}")
  body := initialBody
  var flagSet = flag.NewFlagSet("projects.config.create_branch", flag.ExitOnError)
  ...
  return Subcommand{
    ...
    res, err := client.Projects.Config.NewBranch(
      context.TODO(),
      *projectName,
...
func createProjectsConfigCreateCommitSubcommand(initialBody []byte) (Subcommand) {
  var projectName *string = nil
  query := []byte("{}")
  header := []byte("{}")
  body := initialBody
  var flagSet = flag.NewFlagSet("projects.config.create_commit", flag.ExitOnError)
  ...
  return Subcommand{
    flagSet: flagSet,
    handle: func(client *stainlessv0.Client) {
    res, err := client.Projects.Config.NewCommit(
      context.TODO(),
      *projectName,
...
func createProjectsConfigMergeSubcommand(initialBody []byte) (Subcommand) {
  var projectName *string = nil
  query := []byte("{}")
  header := []byte("{}")
  body := initialBody
  var flagSet = flag.NewFlagSet("projects.config.merge", flag.ExitOnError)
  ...
  return Subcommand{
    flagSet: flagSet,
    handle: func(client *stainlessv0.Client) {
    res, err := client.Projects.Config.Merge(
      context.TODO(),
      *projectName,
